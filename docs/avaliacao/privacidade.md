...
| PRI-08 | Quando a natureza do tratamento dos dados, os riscos de privacidade ou as regras institucionais aplicáveis tornarem a questão pertinente, a necessidade de RIPD ou de consulta à instância institucional responsável por proteção de dados foi considerada?  | RIPD, registro de consulta, decisão institucional                         | Verificação institucional                                        |
